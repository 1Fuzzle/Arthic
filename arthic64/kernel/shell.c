...
{
	kprintf("Arthic 64, stage 3 of the long mode port.\n");
	kprintf("Boots into 64-bit, handles interrupts, reads the keyboard.\n");
	kprintf("Memory manager, paging, heap, TSS, and SYSCALL/SYSRET.\n");
	kprintf("No scheduler or filesystem yet - still on the 32-bit branch.\n");
}
